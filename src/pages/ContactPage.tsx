...
function createContactSchema(t: (key: string, options?: Record<string, unknown>) => string) {
  return z.object({
    name: z.string().min(2, { message: t('contact.formMinLength', { min: 2 }) }),
    email: z.string().email({ message: t('contact.formInvalidEmail') }),
    subject: z.string().min(3, { message: t('contact.formMinLength', { min: 3 }) }),
    message: z.string().min(10, { message: t('contact.formMinLength', { min: 10 }) }),
  });
}
      ...
      <SEO
        ...
        jsonLd={[
          ...
          createBreadcrumbSchema([
            ...
            { name: t('nav.contact'), url: `/${lang || 'en'}/contact` },
          ]),
        ]}
      />
      ...
      <section className="section-padding relative overflow-hidden" id="contact-page">
        ...
        <div className="container-tight relative z-10">
          ...
          <ScrollReveal direction="up" className="text-center mb-16">
            ...
            <h1 className="mb-6">
              {isDE ? (
                <>Kontaktieren <span className="gradient-neon-text">Sie uns</span></>
              ) : (
            ...
            {CONTACT_CARDS.map((card, i) => {
              ...
              return (
                <Wrapper
                  key={i}
                  {...wrapperProps}
                  className={`contact-card glass p-6 rounded-2xl border border-border/50 
                ...
                >
                  ...
                  {card.href && (
                    <ExternalLink className="w-3.5 h-3.5 text-muted-foreground/40 mt-2 group-hover:text-foreground transition-colors" />
                  )}
                </Wrapper>
              );
            })}
              ...
              <div className="glass p-8 rounded-3xl border border-border/50">
                ...
                {isSuccess ? (
                  <div className="text-center py-12">
                    ...
                    <button
                      onClick={handleReset}
                      className="text-neon-pink hover:underline text-sm font-medium"
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          className="h-11 rounded-xl glass border-border/50"
                          {...register('name')}
                        />
                        {errors.name && (
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl glass border border-border/50 bg-transparent px-3 py-2.5 text-sm 
                    ...
                    <Button
                      ...
                      size="lg"
                      className="w-full bg-neon-pink hover:bg-neon-pink/90 text-white font-heading text-sm font-semibold
              ...
              <ScrollReveal direction="right" delay={0.1}>
                <div className="glass p-6 rounded-2xl border border-border/50 relative overflow-hidden">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-green-500 hover:bg-green-600 
                               text-white text-sm font-semibold font-heading transition-colors duration-200
                               shadow-[0_0_16px_rgba(34,197,94,0.3)] hover:shadow-[0_0_24px_rgba(34,197,94,0.4)]"
                    id="contact-whatsapp"
                  >
                  ...
                  <div className="space-y-3">
                    {SOCIAL_LINKS.map((social) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`flex items-center gap-3 p-3 rounded-xl ${social.bg} transition-all duration-200 group`}
