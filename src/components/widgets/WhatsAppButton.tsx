 ...
 * - Green pulsing icon
 * - Opens wa.me with prefilled text
 * - Hides while scrolling, reappears when paused
 */
export function WhatsAppButton() {
  ...
  const whatsappUrl = `https://wa.me/${siteConfig.whatsapp.number}?text=${encodeURIComponent(prefillText)}`;
